...
export const getRoadmap = (state, education, role, t) => {
    ...
    let steps = [
        {
            id: 1,
            title: t('step1_title', "Higher Secondary (Class 12)"),
    ...
    if (education === "Class 12 (Any Stream)") {
        steps.push({
            id: 2,
            title: t('step2_title', "Law Entrance Exams"),
            desc: t('step2_desc', "Clear CLAT/AILET to enter a 5-year Integrated LLB program."),
            icon: "📚"
        });
        steps.push({
            id: 3,
            title: t('step3_title', "Pursue LLB Degree"),
        ...
        steps.push({
            id: 2,
            title: t('step2_title_3yr', "Law Entrance for Graduates"),
